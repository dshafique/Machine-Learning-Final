...
#sys arg 1
TRAIN_DATA_IMG = "C:\\Users\dawud\Desktop\digits.png"

#sys arg 2
USER_IMG = "C:\\Users\dawud\Desktop\test_image.png"

DIGIT_DIM = 20  # size of each digit is SZ x SZ
CLASS_N = 10  # 0-9
fn='C:\\Users\dawud\Desktop\digits.png'
...
def load_digits(fn):
    ...
    digits_img = cv2.imread('C:\\Users\dawud\Desktop\digits.png', 0)
